// GENERATED by tools/sync_stock_bar.py from Omarchy stock sources. DO NOT EDIT.
  ...
  component CenterModules: Item {
    ...
    Component {
      ...
      Item {
        ...
        ModuleList {
          visible: centerRoot.hasAnchor
          entries: root.entriesBefore(centerRoot.entries, centerRoot.anchor)
          region: "center"
          screenName: centerRoot.screenName
        ...
        ModuleList {
          visible: centerRoot.hasAnchor
          entries: root.entriesAfter(centerRoot.entries, centerRoot.anchor)
          region: "center"
          screenName: centerRoot.screenName
